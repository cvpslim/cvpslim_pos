...
class AnulacionsController extends AppController {
     public $name='Anulacions';
     public $components=array('Session');
 
 public function index() {
     $anulacions = $this->Anulacion->find('all');
     $this->set('anulacions', $anulacions);
     
}

 public function add() {
		if (!empty($this->data)) {
			$this->Anulacion->create($this->data);
			if ($this->Anulacion->save()) {
    ...
    function edit($id = null) {
		...
		if (!empty($this->data)) {
			if ($this->Anulacion->save($this->data)) {
		...
		if (empty($this->data)) {
			$this->data = $this->Anulacion->read(null, $id);
		}
    }
    ...
    function view($id = null) {
		...
		$this->set('anulacion', $this->Anulacion->findById($id));
	}
