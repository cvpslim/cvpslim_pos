...
'Empty' => array(
'message' => __d('meio_upload', 'Suba una imagen por favor...')
),
'UploadError' => array(
...
* @access public
*/
function beforeValidate(Model $model, $settings = array()) {
...
* @access public
*/
function beforeSave(Model $model, $settings = array()) {
...
* @access public
*/
function afterSave(Model $model, $created, $settings = array()) {
