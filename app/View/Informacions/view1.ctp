    ...
    <div class="col-xs-6">
      ...
      <table class="table table-striped">
        ...
        <tr>
                    ...
                    <td><?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span> ',array('controller'=>'Guarns','action' => 'edit1', $guarnicione['guarns']['id'],$informacion['Informacion']['id']),array('class'=> 'btn btn-primary','escape'=>false)); ?>
                    </td>
                    
                    <td><?php echo $this->Html->link('<span class="glyphicon glyphicon-remove-circle"></span> ',array('controller'=>'Guarns','action' => 'delete1',  $guarnicione['guarns']['id'],$informacion['Informacion']['id']), 
