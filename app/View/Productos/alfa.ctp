...
<div class="pagination">
	...
	<tr>
            <td><?php echo $producto['productos']['nombre']; ?> </td>
		<td><?php echo $producto['productos']['precio']; ?> </td>
...
<td class="actions">
 ...
 <?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span> ',array('action' => 'edit', $producto['productos']['id']),array('class'=> 'btn btn-warning','escape'=>false)); ?>
<td> <?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span> ',array('action' => 'delete', $producto['productos']['id']), 
        array('class'=> 'btn btn-danger','escape'=>false), sprintf('EstÃ¡ seguro de que desea eliminar %s?', $producto['productos']['id'])); ?></td>
