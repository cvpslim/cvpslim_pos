...
<div class="text text-center modal-body" >
    <span class="h3 text-primary">Ingrese precio</span>
    <br><br>
    <div class="numeric_pad">
        <div class="text-center"><input name="caja_codigo" id="caja_codigo" type="text" class="form-control input-lg"></div>
            ...
            <div class="block_vertical"><button onclick="setOpenPrice();" class="numeric_button_vert">Enter</button></div>
