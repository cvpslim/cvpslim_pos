    ...
    <div class="panel-heading"> <font size="+1"><b>Detalle de los Personal </b></font></div>
        ...
        <div class="panel-footer">
                ...
                <ul>
                   ...
                   <?php echo $this->Html->link('<span class="glyphicon glyphicon-trash"> Eliminar</span> ',array('action' => 'delete', $personal['Personal']['id']), 
...
<div class="row">
    ...
    <div class="panel-body">
     <ul class="list-group">
          ...
          <li class="list-group-item"><em ><font size="+0,5"><b><?php echo __('Sueldo') ?> :</b></font></em> <?php echo $personal['Personal']['sueldo']; ?></li>
            ...
            <div class="panel panel-default">
                 <table class="table table-striped">
                  ...
                  <?php foreach ($deres1 as $deres1): 
                     ...
                     <td><?php echo $this->Html->link('<span class="glyphicon glyphicon-trash"></span> ',array('controller'=>'DerechosPersonals','action' => 'eliminar',$idpersonal,$deres1['derechos']['id']), 
